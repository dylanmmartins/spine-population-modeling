...
However, this can be expressed as a stochastic system of discrete events, where $F,H,S,M\in \mathbbm{Z}_{\geq0}$.

The system described by these equations involve 20 possible events affecting the state vector
...
\end{itemize}
% https://www.jneurosci.org/content/jneuro/10/12/4035.full.pdf
...
% https://www.sciencedirect.com/science/article/pii/S001664801100428X?via%3Dihub
% https://pmc.ncbi.nlm.nih.gov/articles/PMC3471296/#ref-list1
% https://link.springer.com/article/10.1007/s12080-018-0386-z#citeas
